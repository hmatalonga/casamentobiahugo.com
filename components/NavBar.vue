  ...
  <Disclosure as="nav" class="bg-white shadow" v-slot="{ open }">
      ...
      <div class="flex h-16 justify-between">
        <div class="flex">
          <div class="flex shrink-0 items-center">
            <img class="h-8 w-auto" src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=indigo&shade=600" alt="Casamento Beatriz e Hugo" />
            <!-- <NuxtImg class="h-8 w-auto" src="/images/logo_bird_small.png" alt="Casamento Beatriz e Hugo"
            placeholder /> -->
          </div>
          <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
            <!-- Current: "border-indigo-500 text-gray-900", Default: "border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700" -->
            <NuxtLink to="/rsvp" class="inline-flex items-center border-b-2 border-transparent px-1 pt-1 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">RSVP</NuxtLink>
    ...
    <DisclosurePanel class="sm:hidden">
      <div class="space-y-1 pb-3 pt-2">
        ...
        <DisclosureButton as="a" href="/rsvp" class="block border-l-4 border-indigo-500 bg-indigo-50 py-2 pl-3 pr-4 text-base font-medium text-indigo-700">RSVP</DisclosureButton>
